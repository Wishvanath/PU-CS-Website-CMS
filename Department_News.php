...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/additionalcss/Department_News.css">
...
<div class="container">
  <div class="title-heading">
               <center><lb>RECENT NEWS</lb></center>
...
<div class="container">
            <div class="alumini_portal">
               

            </div>
            <div class="alumini-heading">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4>Department News / Notification</h4>
                    </div>
...
<!--                        slider image section         -->
                        <div class="col-md-12">
                            <div class="col-md-4" id="registration">
                                ...
                                <div class="panel panel-primary">
                                    <center><h4 style="color: #337ab7;">Register yourself for email notification</h4></center>
                                    <div class="panel-body">
                                        <form>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row-divide"> 
                                    <div class="col-md-6">
                                        <div id="noti">
                                             <label style="height: 20px;width: 500px; background-color: #337ab7;color:white;text-align:center;border-radius: 5%;"> NOTIFICATION </label>
                                             <div class="well">
                                              <ul>
                                                <li>Dept is going to organise a Python workshop on 21st of Dec.<a href="#">see more</a> </li>
                                                  <li>End Semester Examination for Add On Courses, December – 2017...</li>
                                                  <li>End Semester Examination under CBCS regulations, November 2017 – Payment of Exam Fees & Schedule of Examinations</li>
                                                  <li>    Registrar (i/c)   31-10-2017
                                                  Revised </li>
                                              </ul>
                                    ...
                                    <div class="col-md-6">
                                      <div id="news">
                                             <label style="height: 20px;width: 400px; background-color: #337ab7;color:white;text-align:center;border-radius: 5%;"> NEWS </label>
