...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/additionalcss/Result.css">
                  ...
                  <ul class="nav navbar-nav navbar-left">
                      ...
                      <li  class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="Department_Semesterinar.php">Department Semesterinar</a></li>
...
<div class="container" id="result-container">
  <div class="row">
    ...
    <li class="active"><a data-toggle="pill" href="#menu1">MCA</a></li>
    <li><a data-toggle="pill" href="#menu2">M.Tech</a></li>
    <li><a data-toggle="pill" href="#menu3">M.Sc</a></li>
    </ul>
  
  <div class="tab-content">
    <div id="menu1" class="tab-pane fade in active">
      
      <div class="container" id="mca_result">
        <div class="row">
           <div class="panel panel-primary">
             
             <div class="panel-body">
              <center><h3>MCA Academic Result</h3></center>
              <button class="btn btn-primary" style="float:right;margin-top: -40px;">Search</button>
               <hr>
    ...
    <div id="menu2" class="tab-pane fade">
      <div class="container" id="mtech_result">
        <div class="row">
          <div class="panel panel-primary">
            <div class="panel-body">
              <center><h3>M.Tech Academic Result</h3></center>
              <button class="btn btn-primary" style="float:right;margin-top: -40px;">Search</button>
               <hr>
               <table class="table">
                <thead>
    ...
    <div id="menu3" class="tab-pane fade">
      <div class="container" id="msc_result">
        <div class="row">
          <div class="panel panel-primary">
            <div class="panel-body">
              <center><h3>M.Sc Academic Result</h3></center>
              <button class="btn btn-primary" style="float:right;margin-top: -40px;">Search</button>
               <hr>
               <table class="table">
                <thead>
...
<div class="container-fluid footer-section">
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 col-lg-3 first-footer">
            ...
            <i class="fa fa-link" aria-hidden="true"></i> <a href="Department_Semesterinar.php">Semesterinar</a><br>
