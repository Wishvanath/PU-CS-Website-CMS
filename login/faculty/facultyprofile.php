           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  class="active-menu" href="facultyprofile.php"><i class="fa fa-dashboard fa-3x"></i> Profile </a>
                    </li>
                      <li>
                        <a  href=""><i class="fa fa-bullhorn fa-3x"></i> Message </a>
                    </li> 	
                </ul>              
            </div>
