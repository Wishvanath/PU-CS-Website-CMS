...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/additionalcss/Computer_Lab.css">
...
<div class="container">
  <div class="title-heading">
               <center><lb>COMPUTER LAB</lb></center>
...
<div class="container">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4">
        <div class="thumbnail">
          <img id="cspic1" src="img/mtech_lab.jpg">
        </div>
      </div>

      <div class="col-sm-4">
        <div class="thumbnail">
          <img id="cspic1" src="img/mca_lab.jpg">
        </div>
      </div>

      <div class="col-sm-4">
        <div class="thumbnail">
          <img id="cspic1" src="img/lab1.jpg">
        </div>
      </div>
  ...
  =============================================================-->
  <div class="container">
    <h3>Hardware and Softwares</h3>
    <h4>Servers</h4>
    <div class="row">
      
      <div class="col-sm-3 text-center hwsw">
          <img src="img/winserver.jpg">
      </div>
      <div class="col-sm-3 text-center hwsw">
  ...
  <!-- programing
  =============================================================-->
  <div class="container programing">
    <h4>Programming Softwares</h4>
    <div class="row">
      <div class="col-xs-2 text-center">
        <p class="program">C & C++</p>
      </div>
      <div class="col-xs-2 text-center">
        <p class="program">Java,J2EE</p>
      </div>
      <div class="col-xs-2 text-center">
        <p class="program">PHP,ASP</p>
      </div>
      <div class="col-xs-2 text-center">
        <p class="program">MASM Emulator 8086</p>
      </div>
      <div class="col-xs-2 text-center">
        <p class="program">Visual Studio.Net</p>
      </div>
  ...
  =============================================================-->
  <div class="container programing">
    <h4>Database Softwares</h4>
    <div class="row">
      <div class="col-xs-2 text-center">
        <p class="program">MySql</p>
      </div>
      <div class="col-xs-2 text-center">
        <p class="program">Rational Rose</p>
      </div>
      <div class="col-xs-2 text-center">
        <p class="program">Oracal 9i</p>
      </div>
  ...
  =============================================================-->
   <div class="container">
    ...
    <div class="row">
      <div class="col-xs-3">
          <div class="thumbnail">
            <img id="lab-gallary" src="img/labgal1.jpg">
          </div>
      </div>
      <div class="col-sm-3">
          <div class="thumbnail">
            <img id="lab-gallary" src="img/labgal2.jpg">
          </div>
      </div>
      <div class="col-sm-3">
          <div class="thumbnail">
            <img id="lab-gallary" src="img/labgal3.jpg">
          </div>
      </div>
      <div class="col-sm-3">
          <div class="thumbnail">
          <img id="lab-gallary" src="img/labgal4.jpg">
          </div>
      </div>
    </div>
      <div class="row">
      <div class="col-sm-3">
          <div class="thumbnail">
            <img id="lab-gallary" src="img/labgal5.jpg">
          </div>
      </div>
      <div class="col-sm-3">
          <div class="thumbnail">
            <img id="lab-gallary" src="img/labgal6.jpg">
          </div>
      </div>
      <div class="col-sm-3">
          <div class="thumbnail">
            <img id="lab-gallary" src="img/labgal7.jpg">
          </div>
      </div>
      <div class="col-sm-3">
          <div class="thumbnail">
            <img id="lab-gallary" src="img/labgal8.jpg">
          </div>
      </div>
    </div>
</div>
