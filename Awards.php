...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/additionalcss/Awards.css">
...
<div class="container" id="awards">
  <div class="row">
  <div class="col-md-5" id="award-descp">
    <h3>Overall Champion in NIT Calicut </h3>
    <p>
      Students of Computer Science, Pondicherry University is very active in participating in various Activities, Symposium, Fest and many more. The students has secured many Medals and Trophy's. 
    </p>
  </div>
  <div class="col-md-7" id="award-image">
...
<div class="row">
  ...
  <div class="col-md-5" id="award-descp">
    <h3>University Hostel Website Developer</h3>
    <p>
       A team of Website Developers was awarded by the Vice-Chancellor Prof. Anisha B Khan for developing a Website for the University Hostel. The website has a complete information about the currently available hostels, facilities, and campus infrastructure. This website is holding some unique qualities like 3D viewing of the hostel and its premises. It has the all the necessary and emergency information/Contact Numbers like Ambulance, Chief Warden and Warden of respective hostels. 
    </p>
  </div>
</div>
